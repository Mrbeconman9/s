...
UIS.InputBegan:Connect(function(input, gameProcessedEvent)
	if input.KeyCode == Enum.KeyCode.X then
		game:GetService("CoreGui")["Becon Reach"].Enabled = not game:GetService("CoreGui")["Becon Reach"].Enabled
	end	
end)
...
local NewTextField = Page4.TextField({
     Text = "Made by Becon#2526"
 })
local NewTextField = Page4.TextField({
     Text = "Press X to toggle the GUI."
 })
local ac_on
local ac_off
